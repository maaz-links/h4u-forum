...
@section('title', 'Reported Chat Management')

@section('content_header')
    <h1>Chats Reported</h1>
@stop
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @else
                            <td>N/A</td>
                        @endif
                        @if($report->reportedChat)
                            <td>
                                {{-- <a href='{{route('open.conversation',[$report->reportedChat->id])}}'> --}}
                                    {{ $report->reportedChat->user1->name }} & {{ $report->reportedChat->user2->name }}
                                {{-- </a> --}}
                            </td>
                        @else
                            <td>N/A</td>
